...
districts.forEach((district, index) => {
  ...
  let englishName = nameMapping[ukrainianName] || ukrainianName;
  
  // Special handling for Solomianskyi
  if (ukrainianName.includes('Солом')) {
    englishName = 'Solomianskyi';
  }
  
  // Debug: log the name mapping
  console.log(`Processing: "${ukrainianName}" -> "${englishName}"`);
